...
module "keypair" {
  ...
  public_key                 = "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABgQDb073dkknt6Y3/+/qJv9+= rohit@rohit"
...
module "ssh" {
  source = "git::https://github.com/SyncArcs/terraform-aws-security-group.git?ref=v1.0.0"
